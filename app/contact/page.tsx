...
const mapQuery = encodeURIComponent(
  "ARPT, Centre Directionnel de Koloma, Conakry, Guinée",
);
...
const motifReclamations = [
  {
    value: "qualite_internet",
    label: "Qualité de service internet (débit lent, coupures fréquentes)",
  },
  {
    value: "facturation",
    label: "Facturation abusive ou erreur de crédit/forfait",
  },
  { value: "spam", label: "Réception de SMS ou appels indésirables (Spam)" },
  {
    value: "couverture",
    label: "Couverture réseau mobile insuffisante ou absente",
  },
  {
    value: "donnees",
    label: "Atteinte à la protection des données personnelles",
  },
  {
    value: "homologation",
    label: "Problème d'homologation d'équipement ou de licence",
  },
];
          ...
          <aside className="overflow-hidden rounded-2xl border border-border bg-card shadow-soft">
            <div className="bg-primary px-6 py-7 text-primary-foreground">
              ...
              <p className="mt-2 text-sm leading-6 text-primary-foreground/75">
                Contactez directement nos services ou utilisez le formulaire
                sécurisé.
              </p>
            </div>
            ...
            {envoye ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="mt-3 max-w-sm text-sm leading-6 text-muted-foreground">
                  Merci, votre réclamation a bien été transmise au service
                  concerné. Nous vous répondrons dans les plus brefs délais.
                </p>
                <Button
                  variant="outline"
                  className="mt-8"
              ...
              >
                ...
                <div className="grid content-start gap-2 sm:col-span-2">
                  ...
                  <div className="relative">
                    <ClipboardList
                      className="absolute left-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground pointer-events-none z-10"
                      aria-hidden="true"
                    />
                    <Select
                      required
                    ...
                    >
                      <SelectTrigger
                        id="c-objet"
                        className="h-11 bg-background pl-10 text-left transition-all focus-visible:border-primary focus-visible:ring-primary/20"
                      >
                ...
                <div className="grid gap-2 sm:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <Textarea
                      ...
                      onChange={handleInputChange}
                      className="min-h-[160px] resize-none  bg-background pl-10 transition-all focus-visible:border-primary focus-visible:ring-primary/20"
                      required
                      rows={10}
                      maxLength={2000}

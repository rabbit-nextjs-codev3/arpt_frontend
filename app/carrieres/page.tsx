          ...
          {offresEmploi.map((o) => (
            ...
            >
              <div className="min-w-0">
                ...
                <h2 className="mt-3 font-heading text-xl font-semibold">{o.intitule}</h2>
                ...
                <div className="mt-4 flex flex-wrap gap-x-6 gap-y-2 text-sm text-muted-foreground">
                  ...
                  <span className="inline-flex items-center gap-1.5">
                    <CalendarDays className="size-4" aria-hidden /> Clôture : {formaterDate(o.limite)}
                  </span>
                  <span className="inline-flex items-center gap-1.5">
                    <Users className="size-4" aria-hidden /> {o.candidats} candidatures
                  </span>
                </div>
              </div>
